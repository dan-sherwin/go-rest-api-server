...
func StartHttpsServerFromStrings(certFileStr, keyFileStr string, autoSelfSigned bool) {
	// Case: no strings provided — fall back to regular StartHttpsServer behavior
